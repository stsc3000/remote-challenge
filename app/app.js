...
var App = function($el, messageData) {
...
_.extend(App.prototype, {
  ...
  getMessagesListView: function() {
    if (!this.messagesListView) {
      this.messagesListView = new MessagesListView(this.$el.find('#messages-list'), this);
  ...
  getMessagesDetailView: function() {
    if (!this.messagesDetailView) {
      this.messagesDetailView = new MessagesDetailView(this.$el.find('#messages-detail'), this);
    }
